...
class Service(Node): 
    ...
    def __init__(self):
        ...
        self.image_sub = self.create_subscription(Image,'/image',self.camera_callback,QoSProfile(depth=1, reliability=ReliabilityPolicy.BEST_EFFORT))
        ...
        if self.detection == True:
            ...
            for i in range(int(predictions.size / 3)):
                ...
                if np.argmax(predictions[i]) == 0:
                    ...
                    tfrecord = None 
                    output = '/home/' + str(getuser()) + '/turtlebot3_ws/src/Petsitter_Sprint3/petsitter/petsitter_ros2/petsitter/petsitter_detect_pets/german_sheperd_model/test/output/output.jpg' 
                    num_classes = 1 
